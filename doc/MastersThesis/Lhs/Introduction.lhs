...
\begin{itemize}
\item it needs to be a set of well-defined \textit{operational} semantics, thus being \textit{executable};
\item it needs to be related to a \textit{formalized} process;
...
This thesis is a step in a broader story, started in 2018 by Edil Medeiros et al.~\cite{Edil2018}. Medeiros' work had some limitations, such as having difficulty
...
and then addressed. Whilst the implementation of Chapters 2 to 6 were vastly improved during the making of this dissertation, the latest inclusion to this research is
