...
assume we \textit{aren't} use CT as the type alias and instead we will be showing the implementations as if we are using the definition used previously~\cite{Lemos2022} for the
\texttt{CT} type:
